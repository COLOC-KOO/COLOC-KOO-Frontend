...
export default function Home() {
  ...
  return (
    <SiteLayout>
      ...
      {/* Annonces vedettes - Aligné avec le header */}
      ...
      {/* Explore par ville - Aligné avec le header */}
      <section className="bg-gray-50/50 border-y border-border py-10 w-full">
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 xl:px-12">
          <div className="flex items-end justify-between mb-6">
            <div>
              <h2 className="bebas text-3xl">
      ...
      <section className="max-w-[1440px] mx-auto px-4 md:px-8 xl:px-12 py-10">
